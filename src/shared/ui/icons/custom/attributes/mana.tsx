...
export const Mana: React.FC<{
  ...
  return (
    <svg
      ...
      height={height || 24}
      className={className}
      viewBox="0 0 881.21 881.211"
      xmlSpace="preserve"
    >
      <g>
        <path
          d="M742.105,328.411c0-182.3-148.601-329.9-331.201-328.4c-182.9,1.6-328.5,151-325.5,333.9c1.7,100.8,48.8,190.5,121.7,249.7
